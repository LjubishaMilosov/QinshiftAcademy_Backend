...
if(success)
{
    ...
    {
        result = numberOfApples / applesInBasket + 1;  // if we have something like 4.1 then we need to add another basket for that 0.1
    }
        Console.WriteLine($"The number of baskets needed is: {result}");
}
else
{
